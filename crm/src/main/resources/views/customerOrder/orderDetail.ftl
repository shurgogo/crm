			...
			<div class="layui-card-body">
				<form class="layui-form" >
					<div class="layui-form-item layui-row">
						<input type="hidden" id="orderId" value="${(customerOrder.id)!}" />
						<div class="layui-col-xs6">
							<label class="layui-form-label">订单编号</label>
							<div class="layui-input-block">
								<input type="text" class="layui-input"
									   name="name" id="name" value="${(customerOrder.orderNo)!}" readonly="readonly">
							</div>
						</div>
						<div class="layui-col-xs6">
							...
							<div class="layui-input-block">
								<input type="text" class="layui-input"
									   name="fr" id="fr" value="${(orderSum)!}" readonly="readonly">
							</div>
						</div>
					</div>
					...
					<div class="layui-form-item layui-row">
						<div class="layui-col-xs6">
							...
							<div class="layui-input-block">
								<input type="text" class="layui-input"
									   name="address" value="${(customerOrder.address)!}" readonly="readonly">
							</div>
						</div>
						<div class="layui-col-xs6">
							<label class="layui-form-label">支付状态</label>
							<div class="layui-input-block">
								<#if (customerOrder.state)==1>
