layui.use(['table','layer','form'],function() {
    ...
    var tableIns = table.render({
        ...
        url: 'customer_serve/selectCustomerServesByAssigner?'+'state=fw_002', // 访问数据的地址
        cellMinWidth : 95,
        page : true, // 开启分页
        height : "full-125",
        limits : [10,15,20,25],
        ...
        cols : [[
            ...
            {field: 'serviceProce', title: '处理反馈', align:'center'},
            {field: 'serviceProcePeople', title: '处理人', align:'center'},
            {field: 'serviceProceTime', title: '处理时间', align:'center', sort: true},
    ...
    function formatterBtn(customerServe) {
      ...
      return "<a class='layui-btn layui-btn-xs layui-btn-warm' lay-event='pass'>处理</a>"
    ...
    table.on('tool(customerServe)', function(obj){
        switch(obj.event){
            ...
            case 'pass':
                ...
                openCustomerServeDialog("服务管理 - 服务处理", "customer_serve/toCustomerServeHandleForEdit?id=" + obj.data.id);
                break;
