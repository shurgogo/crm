...
<html>
    ...
    <body class="childrenBody">
        <form class="layui-form" style="width:80%;">
            <#--计划项id-->
            <input id="id" name="id" type="hidden" value="${(cusDevPlan.id)!}"/>
            <#--销售计划id-->
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <#if (cusDevPlan.planDate)??>
                        <input type="text" class="layui-input" lay-verify="required" name="planDate"
            ...
            <div class="layui-form-item layui-row layui-col-xs12">
                ...
                <div class="layui-input-block">
                    <input type="text" class="layui-input userEmail"  name="exeAffect"
    ...
    <script type="text/javascript" src="js/cusDevPlan/addAndUpdate.js"></script>
    </body>
</html>