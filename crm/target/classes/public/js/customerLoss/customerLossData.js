layui.use(['table','layer','form'],function() {
    ...
    if ($("#state").val() == 1) {
        tableIns = table.render({
            ...
            url: 'customerReprieve/customerReprieveList?id=' + $("#id").val(),
            cellMinWidth : 95,
            page : true,
            height : "full-125",
            limits : [5,10,15,20],
        ...
        switch(obj.event){
            ...
            case 'ensure':
                layer.prompt({
                    ...
                    // 发送请求
                    $.post(
                        "customerLoss/updateCustomerLossState",
                        {
                            id: $("#id").val(),
                            lossReason: value
                        }, function (data) {
